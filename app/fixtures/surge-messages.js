const surgeMessages = {
  ...
  flankMessages: [
    ...
    "The New Vegan Church murdered all flank providers in town - you’re the only one left!"
  ],

  ribsMessages: [
    "A new study shows eating ribs eliminates crows feet. Celebrities are scrambling for your ribs.",
